      ...
      <div className="space-y-6">
        <div>
          <h1 className="text-3xl font-serif font-bold text-foreground flex items-center gap-3">
            <Users className="w-7 h-7 text-primary" /> Circle
          </h1>
        ...
        {isLoading ? (
          ...
          <Card className="bg-card/50 border-dashed border-border py-16 text-center">
            ...
            <h3 className="text-xl font-medium text-foreground mb-2">Circle is quiet right now</h3>
            <p className="text-muted-foreground max-w-md mx-auto">
              Nobody's dropped a video into the community feed yet. Be the first — choose Circle Drop when you send a whisp.
            </p>
          </Card>
        )}
      </div>
