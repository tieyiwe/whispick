// The 14 languages Blind Whisper supports end-to-end: the top 12 world
// languages by total speakers, plus Swahili and Korean (both explicitly
// requested — most apps' "top N" lists skip Swahili despite its huge East
// African reach, and Korean was added on top of the original 13 per a
// direct product ask). ISO 639-1 codes. Mirrored by hand in
...
// for all 14 up front, but full UI-string translation coverage starts with
// English/Spanish/Swahili/French/German/Chinese/Korean and fills in the
// rest afterward. A language missing full coverage falls back to English
// string-by-string, never to a blank space.
