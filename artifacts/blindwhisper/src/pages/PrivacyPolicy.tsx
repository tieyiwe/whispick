  ...
  return (
    <LegalLayout title="Privacy Policy" updatedDate="August 18, 2026">
      ...
      <LegalSection heading="1. Information We Collect">
        ...
        <p><strong>1.12 Debate Topics.</strong> Debate Topics let a Sender post a short, headline-length prompt to a public feed that anyone can browse and comment on without an account, in the same fully anonymous way as a Blind Circle post — the author's identity is never attached to a Debate Topic or shown to other viewers, and anonymous commenting uses the same visitor-ID and daily-limit mechanics described in Section 1.11. A Sender can retract their own Debate Topic at any time, which removes it from the public feed entirely.</p>
        <p><strong>1.13 Anonymous comment limits.</strong> To keep Blind Circle and Debate Topic discussions genuine rather than spam, a non-account visitor can post a limited number of comments per rolling 24-hour period (currently three), tracked against their visitor ID (Section 1.11) — never against an IP address or any other identifying signal. Creating a free account removes this limit entirely.</p>
        <p><strong>1.14 Content moderation.</strong> Whisps, Text Whisps, Blind Circle comments, and Debate Topics (and their comments) are automatically screened by an AI classifier for sexual/explicit content and for dangerous or harmful language — harassment, threats, hate speech, and incitement — as described in Section 3. Content the classifier flags is queued for review by Blind Whisper administrators; a flag is a signal for a human to look at, not an automatic takedown. A flag raised on a comment from a signed-out visitor is never linked back to any account, since there isn't one to link it to. We display an in-app reminder encouraging kind, genuine, and productive conversation wherever anonymous comments can be posted.</p>
      ...
      <LegalSection heading="2. How We Use Your Information">
        <ul className="list-disc pl-5 space-y-1">
          ...
          <li>To let visitors like and comment on Blind Circle posts and Debate Topics, using an anonymous, device-local visitor ID rather than an account (Section 1.11)</li>
          <li>To screen Whisps, Text Whisps, Blind Circle comments, and Debate Topics for sexual/explicit content and dangerous or harmful language, and to let administrators review flagged content (Section 1.14)</li>
      ...
      <LegalSection heading="3. AI Processing">
        ...
        <p>
          ...
          Whisp, Blind Circle comment, or Debate Topic is sent for automated classification against our content
      ...
      <LegalSection heading="4. Anonymous Delivery and Sender Identity Protection">
        ...
        <ul className="list-disc pl-5 space-y-1">
          ...
          <li>Blind Circle comments, likes, and Debate Topics from a signed-out visitor are tracked only by an anonymous, device-local visitor ID (Section 1.11) — never an IP address, device fingerprint, or any other identifying signal, and never shown to other viewers or the post's Sender.</li>
