    ...
    <LegalLayout title="Privacy Policy" updatedDate="August 8, 2026">
      ...
      <LegalSection heading="2. How We Use Your Information">
        <ul className="list-disc pl-5 space-y-1">
          ...
          <li>To check whether a phone number belongs to a verified Blind Whisper account, solely to route Whisper Link and Text Whisp delivery in-app instead of by text message</li>
