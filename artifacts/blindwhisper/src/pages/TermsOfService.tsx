    ...
    <LegalLayout title="Terms and Conditions of Use" updatedDate="August 18, 2026">
      ...
      <LegalSection heading="5. Sender Responsibilities and Representations">
        ...
        <ul className="list-disc pl-5 space-y-1">
          ...
          <li>For Blind Circle comments and Debate Now posts (and their comments), you understand these are public and anonymous — visible to anyone who can browse that feed, without you being identified as the author — and you'll use them for genuine discussion, not harassment or spam.</li>
      ...
      <LegalSection heading="8. Anonymity, Reveal Flow, and Consent">
        ...
        <p><strong>8.5 Blind Circle comments, private conversations, and Debate Now.</strong> Comments on a Blind Circle post or a Debate Now post are public, like the post itself — visible to anyone browsing that feed — but anonymous: no viewer, including the original poster, is shown who wrote a given comment unless the commenter is themselves the poster (shown only as "the poster," never by name or account). A private conversation started from a Blind Circle post works like a Whisper Link reply thread: anonymous on both sides, unless a Reveal Flow is used. A Debate Now post's author is never disclosed to viewers; only the author themselves can retract a Debate Now post they posted, which removes it from the public feed. You agree not to use anonymous comments or private conversations for harassment, threats, or any conduct prohibited by Section 4.</p>
      </LegalSection>
